...
class editEm(tk.Frame):
    ...
    def retur_menu(self):
        self.frame_inf.destroy()
        self.frame_sup.destroy()
        opciones(self.root, utl.leer_img("./imagenes/add.png", (45, 45)),
         utl.leer_img("./imagenes/edit.png", (45, 45)), utl.leer_img("./imagenes/delete.png", (45, 45)))
    ...
    def __init__(self, root:Tk):
        ...
        volver= tk.Button(self.frame_inf, text= "VOLVER",font=('Arial', 12, BOLD ),
         bg="#09872f", fg='#fcfcfc', width=15, command=self.retur_menu)
...
class opciones(tk.Frame):
    ...
    def __init__(self, root:Tk, op1:ImageTk.PhotoImage, op2:ImageTk.PhotoImage, op3: ImageTk.PhotoImage):
        ...
        regis = tk.Button(self.frame_sup, text= "Registrar Empleado", font=('Arial', 15, BOLD ), 
        ...
        mod = tk.Button(self.frame_sup, text= "Editar Empleado  ", font=('Arial', 15, BOLD ), 
        bg="#11998b", fg='#fcfcfc', image=op2, compound="right", overrelief="flat",
         command=self.editar)
        mod.place(relx=0.30, rely=0.40,relwidth= 0.4, relheight= 0.15)

        eliminar = tk.Button(self.frame_sup, text= "Eliminar Empleado", font=('Arial', 15, BOLD ), 
        bg="#11998b", fg='#fcfcfc', image=op3, compound="right", overrelief="flat",
         command=self.registro)
        eliminar.place(relx=0.30, rely=0.65,relwidth= 0.4, relheight= 0.15)

        volver= tk.Button(self.frame_sup, text= "VOLVER",font=('Arial', 12, BOLD ), 
        bg="#11998b", fg='#fcfcfc', width=15, command=self.v_menu)
...
class Empleados:
    ...
    def __init__(self):  
        ...
        op1 =utl.leer_img("./imagenes/add.png", (45, 45))
        op2 =utl.leer_img("./imagenes/edit.png", (45, 45))
        op3 =utl.leer_img("./imagenes/delete.png", (45, 45))
        opciones(self.ventana, op1, op2, op3)
